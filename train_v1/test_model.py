...
with tf.Session(config=config) as sess:
    ...
    if phone.endswith("_orig"):
        ...
        saver.restore(sess, "/gdata/huangjie/DPED/models_orig/" + phone)
        ...
        for photo in test_photos:
            ...
            misc.imsave("/gdata/huangjie/DPED/visual_results/" + phone + "_" + photo_name + "_enhanced.png", enhanced_image)
            misc.imsave("/gdata/huangjie/DPED/visual_results/" + phone + "_" + photo_name + "_before_after.png", before_after)
        ...
        for i in iteration:
            ...
            # load pre-trained model
            saver = tf.train.Saver()
            saver.restore(sess, "/gdata/huangjie/DPED/models/" + phone + "_iteration_" + str(i) + ".ckpt")
            ...
            for photo in test_photos:
                ...
                misc.imsave("/gdata/huangjie/DPED/visual_results/" + phone + "_" + photo_name + "_iteration_" + str(i) + "_enhanced.png", enhanced_image)
                misc.imsave("/gdata/huangjie/DPED/visual_results/" + phone + "_" + photo_name + "_iteration_" + str(i) + "_before_after.png", before_after)
