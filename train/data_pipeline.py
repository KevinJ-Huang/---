...
class DataPipeline(object):
    ...
    def _augment_data(self, inout, nchan=6):
        ...
        with tf.name_scope('data_augmentation'):
            ...
            #     inout1_1 = utils.blur(inout[:,:,:3])
            #     inout1_2 = inout[:,:,3:]
            #     inout1 = tf.concat([inout1_1,inout1_2],2)
            #     inout2 = tf.image.resize_images(
            #         inout1, [self.output_resolution[0]/self.scale, self.output_resolution[1]/self.scale],
