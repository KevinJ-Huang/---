...
# img = [cv2.imread("12original.png"),cv2.imread("12original.png")]
# x = tf.placeholder(tf.float32, shape=(2,1536,2048,3))
#
# with tf.Session() as sess:
#     sess.run(tf.global_variables_initializer())
#     y = sess.run(blur(x),feed_dict={x:img})
#     cv2.imwrite("1.png",y[1])
#     cv2.waitKey()
