...
def main(args):
  ...
  t_lowres_input = tf.placeholder(tf.float32, (1, 1536/args.scale, 2048/args.scale, 3))
...
if __name__ == '__main__':
  ...
  parser.add_argument('--checkpoint_dir', default='/gdata/huangjie/hdrnet/hdrnet-loss/checkpoint_check/', help='path to the saved model variables')
  parser.add_argument('--input', default='/gdata/huangjie/hdrnet/hdrnet-loss/input/', help='path to the validation data')
  parser.add_argument('--output', default='/gdata/huangjie/hdrnet/hdrnet-loss/output/', help='path to save the processed images')
  parser.add_argument('--scale', default=1, help ='scale of the image resize')
